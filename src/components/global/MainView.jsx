...
const MainView = ({ text, title, image }) => {
  return (
    <>
     <div className='w-full h-[100svh] xl:min-h-screen overflow-y-auto overflow-x-hidden flex flex-col gap-8 items-center justify-start xl:bg-sidebar rounded-r-3xl'>
