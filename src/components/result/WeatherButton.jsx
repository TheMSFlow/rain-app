...
const WeatherButton = ({ icon, main, description, value, onClick }) => {
  return (
    <>
        <button onClick = {onClick} className='flex flex-row h-[40px] sm:h-24 sm:w-36 xl:h-[40px] xl:w-auto sm:justify-between sm:items-start items-center xl:items-center justify-center xl:justify-center px-0 py-[5px] relative bg-white rounded-lg [background:linear-gradient(180deg,rgb(43.35,42.99,42.99)_0%,rgb(107.95,107.95,107.95)_100%)] w-full focus-visible:outline focus-visible:outline-4 focus-visible:outline-accent focus-visible:outline-offset-2 hover:bg-[linear-gradient(135deg,#6C6C6C_0%,#2B2B2B_90.5%)] transition-all ease-in-out duration-300'>
            <div>{icon}</div>
